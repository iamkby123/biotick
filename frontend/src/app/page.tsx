...
function FAQ() {
  const faqs = [
    ...
    { q: "Why can't I just short everything that looks bad?", a: "You could, but shorting has unlimited loss potential — one surprise FDA approval or buyout can send a stock up 200% overnight and wipe out all your gains in a single trade. A safer bearish strategy is buying put options instead. Your max loss is capped at the premium you paid, while still profiting from the downside. Biotick's options flow data helps you spot where smart money is positioning with puts." },
